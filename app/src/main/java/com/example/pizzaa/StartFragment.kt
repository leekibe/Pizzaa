...
import com.example.pizzaa.databinding.FragmentStartBinding
import com.example.pizzaa.model.OrderViewModel
...
class StartFragment : Fragment() {
    ...
    fun orderPizza(quantity: Int) {
        ...
        if (sharedViewModel.hasNoFlavorSet()) {
            sharedViewModel.setFlavor(getString(R.string.beef))
        }

        // Navigate to the next destination to select the flavor of the cupcakes
        findNavController().navigate(R.id.action_startFragment2_to_flavorFragment)
    }
