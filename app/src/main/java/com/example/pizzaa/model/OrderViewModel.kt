package com.example.pizzaa.model
...
private const val PRICE_PER_PIZZA = 2.00
...
class OrderViewModel : ViewModel() {
    ...
    /**
     * Set the flavor of pizzas for this order. Only 1 flavor can be selected for the whole order.
     *
     * @param desiredFlavor is the pizza flavor as a string
     */
